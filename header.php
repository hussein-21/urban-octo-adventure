		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data- toggle="dropdown">Web Projects </a>
                    ...
                    <a class="dropdown-item"href="methodologies.php">Methodologies
                    ...
                    <a class="dropdown-item" href="convert.php ">Converter </a>
                    <a class="dropdown-item" href="coin.php ">Coin Flip </a>
                    <a class=" dropdown-item" href="menu">Restaurant Menu</a>
                    </div> 
                </li>
                <li class="nav-item"><a class="nav-link" href="contact.php">Contact Me</a></li> 
                </ul>
                <ul class="nav navbar-nav navbar-right">
                <li><a class="hover-btn-new log" href="#" data-toggle="modal" data 
                target="#login"><span>Login</span></a></li>
                </ul>
